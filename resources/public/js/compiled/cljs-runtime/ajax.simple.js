...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__66043){
var map__66044 = p__66043;
var map__66044__$1 = cljs.core.__destructure_map(map__66044);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66044__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__66045_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__5043__auto__ = p1__66045_SHARP_;
 ...
 */
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__66050){
var map__66053 = p__66050;
var map__66053__$1 = cljs.core.__destructure_map(map__66053);
var request = map__66053__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66053__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__5043__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
