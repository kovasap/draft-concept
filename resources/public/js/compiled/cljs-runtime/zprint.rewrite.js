...
var G__51068 = rewrite_clj.zip.next(n);
loc = G__51068;
continue;
} else {
var G__51069 = rewrite_clj.zip.next(loc);
loc = G__51069;
continue;
}
} else {
var G__51070 = rewrite_clj.zip.next(loc);
loc = G__51070;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__51040 = zloc;
var G__51040__$1 = (((G__51040 == null))?null:rewrite_clj.zip.node(G__51040));
if((G__51040__$1 == null)){
return null;
} else {
return rewrite_clj.zip.of_node_STAR_.cljs$core$IFn$_invoke$arity$1(G__51040__$1);
}
})())));
});
/**
...
var G__51072 = rewrite_clj.zip.down(nloc);
nloc = G__51072;
continue;
}
break;
...
var G__51073 = rewrite_clj.zip.right(nloc);
var G__51074 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__51073;
out = G__51074;
continue;
} else {
...
var G__51081 = rewrite_clj.zip.right(replaced_loc);
var G__51082 = cljs.core.next(new_loc);
var G__51083 = replaced_loc;
nloc = G__51081;
new_loc = G__51082;
last_loc = G__51083;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__51060_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__51060_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__51060_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
