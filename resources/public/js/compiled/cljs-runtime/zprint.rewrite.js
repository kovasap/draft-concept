...
var G__51422 = rewrite_clj.zip.next(n);
loc = G__51422;
continue;
} else {
var G__51423 = rewrite_clj.zip.next(loc);
loc = G__51423;
continue;
}
} else {
var G__51426 = rewrite_clj.zip.next(loc);
loc = G__51426;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__51375 = zloc;
var G__51375__$1 = (((G__51375 == null))?null:rewrite_clj.zip.node(G__51375));
if((G__51375__$1 == null)){
return null;
} else {
return rewrite_clj.zip.of_node_STAR_.cljs$core$IFn$_invoke$arity$1(G__51375__$1);
}
})())));
});
/**
...
var G__51439 = rewrite_clj.zip.down(nloc);
nloc = G__51439;
continue;
}
break;
...
var G__51442 = rewrite_clj.zip.right(nloc);
var G__51443 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__51442;
out = G__51443;
continue;
} else {
...
var G__51446 = rewrite_clj.zip.right(replaced_loc);
var G__51447 = cljs.core.next(new_loc);
var G__51448 = replaced_loc;
nloc = G__51446;
new_loc = G__51447;
last_loc = G__51448;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__51415_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__51415_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__51415_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
