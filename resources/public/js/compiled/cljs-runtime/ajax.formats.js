...
var G__65929 = request;
var G__65930 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__65929,G__65930) : ajax.formats.get_format.call(null,G__65929,G__65930));
} else {
...
return cljs.core.some((function (p1__65936_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__65936_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__65941){
var map__65942 = p__65941;
var map__65942__$1 = cljs.core.__destructure_map(map__65942);
var request = map__65942__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65942__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__65950 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__65950.cljs$core$IFn$_invoke$arity$1 ? fexpr__65950.cljs$core$IFn$_invoke$arity$1(response) : fexpr__65950.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__65955){
var map__65956 = p__65955;
var map__65956__$1 = cljs.core.__destructure_map(map__65956);
var request = map__65956__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65956__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__65951_SHARP_){
return ajax.formats.get_accept_entries(request,p1__65951_SHARP_);
