...
var G__65972 = request;
var G__65973 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__65972,G__65973) : ajax.formats.get_format.call(null,G__65972,G__65973));
} else {
...
return cljs.core.some((function (p1__65982_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__65982_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__65986){
var map__65988 = p__65986;
var map__65988__$1 = cljs.core.__destructure_map(map__65988);
var request = map__65988__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65988__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__66015 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__66015.cljs$core$IFn$_invoke$arity$1 ? fexpr__66015.cljs$core$IFn$_invoke$arity$1(response) : fexpr__66015.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__66020){
var map__66021 = p__66020;
var map__66021__$1 = cljs.core.__destructure_map(map__66021);
var request = map__66021__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66021__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__66016_SHARP_){
return ajax.formats.get_accept_entries(request,p1__66016_SHARP_);
