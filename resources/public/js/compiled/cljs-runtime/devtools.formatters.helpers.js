...
var G__46155 = devtools.prefs.pref(v);
v = G__46155;
continue;
} else {
return v;
...
}catch (e46019){var _e__45232__auto__ = e46019;
return false;
}})();
...
}catch (e46041){var _e__45232__auto__ = e46041;
return false;
}})();
...
}catch (e46048){var _e__45232__auto__ = e46048;
return false;
}}
}
});
...
var vec__46090 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46090,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46090,(1),null);
...
return cljs.core.some((function (p1__46101_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__46101_SHARP_);
}),template);
});
